...
<style scoped>
	...
	.topper{padding: 0 20px; height: 23vh; background:url(/static/img/ic_group_banner.3baebcf.png) no-repeat center;background-size: 100vw;overflow: visible; }
	...
	.recommend { background: url(/static/img/ic_rec_group_banner_6.84c7876.png) no-repeat;background-size: cover; padding: 6vh 0 5px 10px;margin: 0 10px; text-align: left;font-size: 14px;color: #eee;font-weight: normal; }
